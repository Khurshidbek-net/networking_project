...
export class OutboundController {
  ...
  async update(
    @Param('id') id: string,
    @Body() updateOutboundShipmentDto: UpdateOutboundShipmentDto,
  ) {
  ...
  async updatePickingStatus(
    @Param('id') id: string,
    @Body() body: { pickerId: string; status: string },
  ) {
    return this.outboundService.updatePickingStatus(
      id,
      body.pickerId,
      body.status,
    );
  ...
  async markAsShipped(
    ...
    return this.outboundService.markAsShipped(
      id,
      body.carrier,
      body.trackingNumber,
    );
